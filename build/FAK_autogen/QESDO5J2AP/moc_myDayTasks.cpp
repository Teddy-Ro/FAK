...
#include "../../../FAK/classes/myDayTasks.h"
...
namespace {
struct qt_meta_tag_ZN10MyDayTasksE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN10MyDayTasksE = QtMocHelpers::stringData(
    "MyDayTasks",
...
Q_CONSTINIT static const uint qt_meta_data_ZN10MyDayTasksE[] = {
...
Q_CONSTINIT const QMetaObject MyDayTasks::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10MyDayTasksE.offsetsAndSizes,
    qt_meta_data_ZN10MyDayTasksE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10MyDayTasksE_t,
        // Q_OBJECT / Q_GADGET
...
void MyDayTasks::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MyDayTasks::*)(QWidget * );
            if (_q_method_type _q_method = &MyDayTasks::showDeadlinePanelRequested; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
void *MyDayTasks::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10MyDayTasksE.stringdata0))
