...
#include "../../../FAK/classes/deadlinepanel.h"
...
namespace {
struct qt_meta_tag_ZN13DeadlinePanelE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13DeadlinePanelE = QtMocHelpers::stringData(
    "DeadlinePanel",
    "deadlineApplied",
    "",
    "deadline",
...
Q_CONSTINIT static const uint qt_meta_data_ZN13DeadlinePanelE[] = {
...
Q_CONSTINIT const QMetaObject DeadlinePanel::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13DeadlinePanelE.offsetsAndSizes,
    qt_meta_data_ZN13DeadlinePanelE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13DeadlinePanelE_t,
        // Q_OBJECT / Q_GADGET
...
void DeadlinePanel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DeadlinePanel::*)(const QDateTime & );
            if (_q_method_type _q_method = &DeadlinePanel::deadlineApplied; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (DeadlinePanel::*)();
            if (_q_method_type _q_method = &DeadlinePanel::cancelled; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
void *DeadlinePanel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13DeadlinePanelE.stringdata0))
