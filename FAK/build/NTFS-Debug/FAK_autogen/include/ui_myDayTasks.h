...
"}"));
        ...
        textInput->setStyleSheet(QString::fromUtf8("background-color: #131118;\n"
"color: #f7f3e3;\n"
"border: 1px solid #8d6a9f;\n"
"border-radius: 4px;\n"
"padding: 8px 12px;\n"
...
"border: none;"));
        ...
        scrollAreaWidgetContents->setStyleSheet(QString::fromUtf8("background-color: #0c1618;"));
